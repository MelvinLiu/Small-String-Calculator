...
|*					  - receive strings that passed Gate Keeper class					|
|*					  - return the indix notation array back to CalculatorCentral class	|															
...
|*					  		- return list back to CalculatorCentral class					        		|					
|*		Visibility	  	    - public																		|					
...
___________StringBuffer Append Cases_________________________________________________________________
...
|		   Jump over the decimal point. Append the rest of the number. 								|
|		   Once done, give the decimal point back -> num = num / 10^length() 						|
...
|		   #4.1 '-' must be a minus sign if the char before it is a number or a ')';				|
|		   #4.2 The rest must be negative sign. 													|
*****************************************************************************************************
