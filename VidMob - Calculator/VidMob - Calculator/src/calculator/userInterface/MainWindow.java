...
*Class Purpose - to create the main window and to receive user input and display the calculation result		
*Class Dependency - created by Welcome Window class, creates CalculatorCentral class object, and received calculation result from CalculatorCentral object class 
...
*																			   
*2. buildMainWindow()																   			
*Purpose - to build main window; to take user input from text field; to display the calculation result						 
*Dependency - called by MainWindow constructor; calls actionPerformed(e) method							   
*Visibility - private													   
*Intake parameters - n/a						                                   
*Return type - void					                                   
*																					  
*3. actionPerformed(ActionEvent e)													   		
*Purpose - to create CalculatorCentral object and pass input string; to receive calculation result from CalculatorCentral object; to clear input field and result field when clicking 'clear'
*Dependency - called by buildWelcomePage() method and calls CalculatorCentral constructor						  
*Visibility - public 													  
