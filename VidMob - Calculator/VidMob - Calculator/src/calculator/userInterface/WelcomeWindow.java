...
*Class Dependency - created by AppRunner class and creates MainWindow class
...
*Dependency	- called by WelcomeWindow constructor and calls actionPerformed(e) method
*Visibility - private
*Intake parameters - n/a
*Return type - void
*
*3. actionPerformed(ActionEvent e)
*Purpose - to create MainWindow object and direct user to main page and implemented from ActionListener interface
*Dependency - called by buildWelcomePage() method and calls MainWindow constructor
*Visibility	- public
